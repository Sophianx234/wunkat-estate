...
function Hero() {
  return (
    <div className="py-24 z-1   pt-36">
      ...
      <h1 className={` sm:text-7xl text-5xl text-center  antialiased  font-bold lg:pt-3 lg:px-16 lg:font-extrabold  sm:tracking-tight sm:leading-20  px-6 text-gray-200 font-archivo uppercase sm:pt-16`}>Crafting your dream   space,  inside and out</h1>
