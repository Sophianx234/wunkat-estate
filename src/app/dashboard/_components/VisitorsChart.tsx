  ...
  return (
    <div className="">
      <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
        ...
        <CardAction className="flex gap-2">
          ...
          <ToggleGroup
            ...
            variant="outline"
            className="hidden @[767px]/card:flex gap-1"
          >
          ...
          <Select value={timeRange} onValueChange={setTimeRange} className="@[767px]/card:hidden">
            <SelectTrigger className="w-36 sm:w-40" size="sm" aria-label="Select a range">
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6 overflow-x-auto">
        <div className="min-w-[700px] sm:min-w-full"> {/* Enables horizontal scroll for small screens */}
          <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
            <AreaChart data={filteredData}>
              <defs>
                <linearGradient id="fillThisYear" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-thisYear)" stopOpacity={1} />
                  <stop offset="95%" stopColor="var(--color-thisYear)" stopOpacity={0.1} />
                </linearGradient>
                <linearGradient id="fillLastYear" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-lastYear)" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="var(--color-lastYear)" stopOpacity={0.1} />
                </linearGradient>
              </defs>
