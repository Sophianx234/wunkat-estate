...
const roomsData: Room[] = [
  { id: "R-101", name: "Room 101", smartLock: true, status: "Locked" },
  { id: "R-102", name: "Room 102", smartLock: true, status: "Unlocked" },
  { id: "R-103", name: "Room 103", smartLock: false, status: "Manually Locked" },
  { id: "R-104", name: "Room 104", smartLock: true, status: "Locked" },
  { id: "R-105", name: "Room 105", smartLock: false, status: "Unlocked" },
  { id: "R-106", name: "Room 106", smartLock: true, status: "Locked" },
  { id: "R-107", name: "Room 107", smartLock: false, status: "Manually Locked" },
];
        ...
        <table className="w-full text-sm text-left border-collapse">
          <thead>
            <tr className="border-b border-gray-200 dark:border-neutral-700">
              <th className="py-2 px-3 text-gray-600 dark:text-gray-400">Room ID</th>
              <th className="py-2 px-3 text-gray-600 dark:text-gray-400">Name</th>
              <th className="py-2 px-3 text-gray-600 dark:text-gray-400">Smart Lock</th>
